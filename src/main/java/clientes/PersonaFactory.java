...
/**
 * @author Grupo12
 * Se encarga de crear una persona segun su tipo<br>
 *
 */
public class PersonaFactory {
	...
	/**
	 * <b>Pre</b> No tiene<br>
	 * <b>Post</b> Devolvera una persona en caso de no poder lanzara una excepcion correspondiente a cada error <br>
	 ...
	 * @throws MedioPagoInvalidoException : en caso de que el medio de pago sea invalido<br>
