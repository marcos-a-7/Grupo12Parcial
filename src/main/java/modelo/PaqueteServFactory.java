...
public class PaqueteServFactory {

	public PaqueteServFactory() {
		// TODO Auto-generated constructor stub
	}

	public PaqueteServicios getPaqueteServicios(String tipoInternet, int cantCelu, int cantTel, int cantCable) throws ImposibleCrearPaqueteException {
